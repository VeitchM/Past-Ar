...
export default function HomeCalibration({ navigation }: PropsCalibrationHome) {
  //======= Hooks ==================================
  const connectionState = useTypedSelector(
    ...
    >
      ...
      >
        <RoundedContainer size={329} height={264} borderRadius={33}>
          <VStack flex={1} justifyContent="space-around">
            <Heading paddingTop={5} height={85} width={220} size="md">
              {TS.t("calibration_home_header")}
            </Heading>
            <View>
              <Divider />
            </View>
            ...
            >
              ...
              <Select
                ...
                onValueChange={(itemValue) => setSelectedCalibration(itemValue)}
                minWidth="150"
                placeholder={TS.t("choose")}
              >
          ...
          <VStack flex={0.7} justifyContent="space-evenly">
            {connectionState == "connected" ? (
              <Button
                isDisabled={selectedCalibration === ""}
                onPress={toCalibrationMeasurementScreen}
              >
                {selectedCalibration != ""
                  ? "Realizar Medicion"
                  : "Elija Calibración"}
      ...
      <VStack bg="muted.50" alignSelf="flex-end" width="100%">
        <BlockButton
          ...
          text={TS.t("calibration_list_button")}
          onPress={() => {
        ...
        <BlockButton
          ...
          onPress={() => {
            navigation.navigate("ForSendingCalibrations");
          }}
          text={TS.t("calibration_send_button")}
        />
      </VStack>
    </VStack>
  );
