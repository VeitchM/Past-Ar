...
export default function BottomSheetItem({ title, points, index, backgroundColor, foreColor, color, enabled, onLocatePress: onLocatePress, onEditPress: onEditPress }: ItemProps) {
